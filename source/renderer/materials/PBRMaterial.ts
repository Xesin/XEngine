	...
	export class PBRMaterial extends Material {
		...
		public bind(renderer: Renderer) {
			...
			if (this.smoothnessTexture) {
				renderer.bindTexture(this.smoothnessTexture, renderer.gl.TEXTURE4);
			} else {
				renderer.bindTexture(null, renderer.gl.TEXTURE4);
			}

			if (this.metallicTexture) {
				renderer.bindTexture(this.metallicTexture, renderer.gl.TEXTURE5);
			} else {
				renderer.bindTexture(null, renderer.gl.TEXTURE5);
			}
		}
