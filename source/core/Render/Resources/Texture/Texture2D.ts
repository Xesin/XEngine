...
export class Texture2D {
	...
	public static createTexture(name: string, width: number, height: number, data: Uint8Array | Float32Array, wrap: WRAP_MODE, generateMipMaps: boolean, gl: WebGL2RenderingContext, isNormal = false, internalFormat: number = gl.RGBA, srcFormat :number = gl.RGBA, type: number = gl.UNSIGNED_BYTE): Texture2D {
