...
export class ImageLoader implements BasicLoader {
    ...
    private loadCommon() {
        ...
        let handler = function () {
            _this.loader.game.cache.images[_this.imageName] =
            Texture2D.createTexture(
                _this.imageName, this.width, this.height, this, WRAP_MODE.REPEAT,
                !_this.isNormal, _this.loader.game.renderer.gl, _this.isNormal);
            _this.completed = true;
            _this.loader._notifyCompleted();
        };
        img1.onload = handler;
    ...
    private loadTGA() {
        ...
        xhr.onload = function() {
            if (this.status === 200) {
                ...
                _this.loader.game.cache.images[_this.imageName] =
                Texture2D.createTexture(
                    _this.imageName, imageData.width, imageData.height,
                    imageData.data, WRAP_MODE.REPEAT, !_this.isNormal, _this.loader.game.renderer.gl, _this.isNormal);
                _this.completed = true;
                _this.loader._notifyCompleted();
            }
        };
