var CustomShader = function (game) {
 ...
 */
        ...
        "void main() {",
            ...
            "vec3 dir = normalize(vec3(fUv.xy,-2.0)); dir.z += length(fUv) * 0.15;",
...
CustomShader.prototype = {
	...
	start: function () {
		this.rect = this.game.add.rect(0,0,this.game.width, this.game.height);
